...
const DFilter: React.FC<DFilterProps> = ({ title }) => {
    ...
    <div className=" flex justify-between p-4">
      <div className="flex items-center relative">
        <button
          ...
          onClick={() => navigate(RouterConstantUtil.page.home)}
        >
          <ChevronLeft size={20} color="black" />
          <span className="text-[#1E2B3A] font-medium">Back</span>
        </button>
        <span className="text-[#2C2C2E] text-[20px] ml-4 whitespace-nowrap font-bold font-sans">
          {title}
        </span>
      </div>
      <div className="hidden md:flex items-center gap-4">
        ...
        <div className="flex-1 relative">
          <div className="relative">
            ...
            <input
              ...
              className="w-full min-w-[400px] bg-white pl-10 pr-4 py-2 border border-[#F0F0F0] rounded-lg focus:outline-none focus:border-teal-500 focus:bg-white"
            />
          </div>
        </div>
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none bg-white border border-[#F0F0F0] rounded-lg px-4 py-2 pr-8  max-w-[170px] text-gray-700 focus:outline-none focus:border-teal-500 focus:bg-white"
          >
    ...
    <AnimatePresence mode="wait">
      {isModalOpen && (
        ...
        >
          ...
          {/* Animated Modal */}
          <motion.div
            className="relative bg-white rounded-t-2xl lg:rounded-2xl p-4 lg:p-6 w-full max-w-xl mx-0 lg:mx-4 max-h-[90vh] overflow-y-auto lg:mb-8"
