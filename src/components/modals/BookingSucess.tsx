      ...
      <DialogContent className="sm:max-w-xl p-0 bg-white rounded-2xl border-none shadow-2xl">
        ...
        <div className="flex flex-col items-center pt-8 pb-6">
          <div className="relative flex items-center justify-center mb-6">
            <motion.div
              className="absolute w-24 h-24 border-2 border-[#00C2A8]/20 rounded-full"
              variants={rippleVariants}
              initial="hidden"
              animate="visible"
            />
            <motion.div
              className="absolute w-20 h-20 border-2 border-[#00C2A8]/30 rounded-full"
              variants={rippleVariants}
              initial="hidden"
              animate="visible"
            ...
            <img src="/icons/ICON2.png" className="h-24 w-24" alt="handyme" />
          </div>

          <h2 className="text-xl font-bold text-[#00C2A8] mb-2">
            Booking Confirmed
          </h2>
        </div>

        <div className="pb-6">
          <div className="mx-5 px-4 p-2 rounded-md mb-4 border border-dashed border-[#6CA0FE]/30">
            ...
            <div className="space-y-4 my-6">
              ...
              {/* Dotted Line */}
              <div className="border-b border-dashed border-[#6CA0FE]/30 my-2 lg:my-4"></div>
          ...
          <div className="px-5">
            <button
              onClick={onClose}
              className="w-full py-3 bg-transparent border-2 border-[#00C2A8] text-[#00C2A8] rounded-xl font-semibold hover:bg-[#F7F9FA] transition-colors duration-200"
            >
              Home
            </button>
          </div>
